...
// if you want this page have no Gdiplus::Bitmap errors,  
// you need to define NOMINMAX
// whitch is done in Headers.h
...
Surface Surface::FromFile(const std::string& name)
{
...

	{
		...
		UINT status = bitmap.GetLastStatus();
		if (status != Gdiplus::Status::Ok)
		{
			std::stringstream ss;
			ss << "Loading image [" << name << "]: failed to load. Status : ["<<status<<"]";
