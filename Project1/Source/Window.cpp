...
// forward declaration (imgui_impl_win32.h)
	...
	hInst(GetModuleHandle(nullptr))
{
	...
	wc.hIconSm = static_cast<HICON>(LoadImage(hInst, MAKEINTRESOURCE(IDI_ICON1), IMAGE_BITMAP, 16, 16, 0));
	RegisterClassEx(&wc);
}
...
bool Window::SetTitle(const char* InTitle)
{
